...
<form action="insert_db.php" method="POST">
    <table class="t1">
        ...
        <tr>
            ...
            <td>
            <?php
            $sql = "SELECT * FROM enrolment WHERE student_id='$student_id' AND course_id='1' ";
            $result = mysqli_query($connectivity, $sql);
            
            while ($row = mysqli_fetch_assoc($result)) {
                $enrolment_status1 = $row['enrolment_status'];
            }
     echo $enrolment_status1;?>
            </td>
            <td>
            <input <?php
            
            if ($enrolment_status1 != '') {
              echo 'style="visibility: hidden;"';
            }
            ?>  type="checkbox" name ="course_id" value = "1">
        ...
        <tr>
            ...
            <td></td>
            <td><?php
            $sql = "SELECT * FROM enrolment WHERE student_id='$student_id' AND course_id='6' ";
            $result = mysqli_query($connectivity, $sql);
            
            while ($row = mysqli_fetch_assoc($result)) {
                $enrolment_status2 = $row['enrolment_status'];
            }
     echo $enrolment_status2;?></td>
            <td><input <?php
            
            if ($enrolment_status2 != '') {
              echo 'style="visibility: hidden;"';
            }
            ?>  type="checkbox" name ="t_id" value = "6">
            </td>
            <td><input <?php
